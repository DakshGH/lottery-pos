...
**Docs:** how it all works in [ARCHITECTURE.md](ARCHITECTURE.md) · build history
& roadmap in [CHANGELOG.md](CHANGELOG.md) · pricing in [PRICING.md](PRICING.md) ·
anti-theft design in [LICENSING.md](LICENSING.md).
